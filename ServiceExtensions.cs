...
public static class ServiceExtensions
{
    ...
    /// </summary>
    public static IServiceCollection RegisterAzureBlobStorageWithFakeConfig(this IServiceCollection services)
    {
    ...
    public static IServiceCollection RegisterBlobStorageClient(this IServiceCollection services)
    {
